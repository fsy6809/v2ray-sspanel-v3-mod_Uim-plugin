...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/fsy6809/v2ray-sspanel-v3-mod_Uim-plugin/releases/download/${NEW_VER}/v2ray-linux-${VDIS}.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/fsy6809/v2ray-sspanel-v3-mod_Uim-plugin/releases/latest"
